...
var ParallaxView = React.createClass({
    ...
    propTypes: {
        ...
        backgroundHeight: React.PropTypes.number,
    ...
    renderBackground: function () {
        var { windowHeight, backgroundHeight, backgroundSource, blur } = this.props;
                ...
                style={[styles.background, {
                    ...
                    transform: [{
                        translateY: scrollY.interpolate({
                            ...
                            outputRange: [backgroundHeight/2, 0, 0]
                        })
                    },{
    ...
    render: function () {
        var { style, backgroundHeight, ...props } = this.props;
        return (
